...
data class MealResponse(
    ...
    @field:SerializedName("strDrink_alternate") val strDrinkAlternate: String,
    ...
    @field:SerializedName("strCreativeCommonsConfirmed") val strCreativeCommonsConfirmed: String,
    @field:SerializedName("dateModified") val dateModified: String,
)
